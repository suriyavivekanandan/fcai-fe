...
function InitialEntry() {
  ...
  const [entries, setEntries] = useState([{ food_item: FOOD_ITEMS[0], initial_weight: '' }]);
  ...
  const handleFetchWeight = async (index) => {
    ...
    try {
      // Use the mock function instead of the actual ESP8266 integration
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Instead of saving to database, we'll just log the entries
      console.log('Food entries saved:', foodEntries);
